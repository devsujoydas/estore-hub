        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-5 md:mx-0 mx-5">
            <div className="max-w-sm bg-white px-6 pt-6 pb-2 rounded-xl shadow-lg transform hover:scale-105 transition duration-500">
                ...
                <div className="my-4">
                    ...
                    <button className="mt-4 text-xl w-full text-white bg-indigo-600 py-2 rounded-xl shadow-lg cursor-pointer">Buy Lesson</button>
                </div>
            </div>
            ...
            <div className="max-w-sm bg-white px-6 pt-6 pb-2 rounded-xl shadow-lg transform hover:scale-105 transition duration-500">
                ...
                <div className="my-4">
                    ...
                    <button className="mt-4 text-xl w-full text-white bg-indigo-600 py-2 rounded-xl shadow-lg cursor-pointer">Start Watching Now</button>
                </div>
            </div>
